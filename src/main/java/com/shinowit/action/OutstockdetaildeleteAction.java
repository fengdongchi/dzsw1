 ...
 */
public class OutstockdetaildeleteAction extends ActionSupport {
    ...
    public String delete(){
        ...
        for(String s:ss){
            outstockdetaildao.executeHQL("delete from TMeOutStockDetailsInfo where id=?",Integer.valueOf(s));
            a+=1;
        }
            if(a>0){
